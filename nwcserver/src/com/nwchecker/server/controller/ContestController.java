...
/**
 * <h1>Contest Controller</h1> This spring controller contains mapped methods,
 * that allows to read, create and edit contests in database.
 * <p>
 * <b>Note:</b>Only teacher allows to create and change contests. Other users
 * can only view contests information
 *
 * @author Roman Zayats
 * @version 1.0
 */
...
public class ContestController {
	...
	/**
	 * This mapped method used to return page when teacher can create new
	 * contest.
	 * <p>
	 ...
	 *            This is general information about user, who tries to call this
	 *            method
	 * @return <b>contestCreate.jsp</b> Returns page where user can create new
	 *         contest
	 */
	...
	/**
	 * This mapped method used to receive new contest data and create new
	 * contest in database.
	 * <p>
	 * <b>Note:</b>Only TEACHER has rights to use this method.
	 *
	 * @param contestAddForm
	 *            Data set that contains information about new contest
	 * @param principal
	 *            This is general information about user, who tries to call this
	 *            method
	 * @param result
	 *            General spring interface that used in data validation
	 * @return Returns "SUCCESS" status if <b>success</b>. Returns "FAIL" status
	 *         if <b>fails</b>.
	 */
	@PreAuthorize("hasRole('ROLE_TEACHER')")
	...
	/**
	 * This mapped method used to return page where teacher can edit selected
	 * contest.
	 * <p>
	 * <b>Note:</b>Only TEACHER has rights to use this method.
	 *
	 * @param id
	 *            ID of contest that will be edited
	 * @param principal
	 *            This is general information about user, who tries to call this
	 *            method
	 * @param model
	 *            Spring Framework model for this page
	 * @return <b>contestCreate.jsp</b> Returns page where teacher can edit
	 *         contest
	 */
	...
	public String initEditContest(@RequestParam("id") int id,
			Principal principal, Model model) {
		/*
		 * if
		 * (!contestService.checkIfUserHaveAccessToContest(principal.getName(),
		 * id)) { return "nwcserver.403"; }
		 */
		// get Contest by id:
	...
	/**
	 * This mapped method used to return list of teachers that have rights to
	 * edit this contest.
	 * <p>
	 * <b>Note:</b>Only TEACHERs and ADMINs have rights to use this method.
	 *
	 * @param contestId
	 *            ID of selected contest
	 * @param principal
	 *            This is general information about user, who tries to call this
	 *            method
	 * @return <b>JSON</b> Returns <b>List of Teachers</b> than can edit this
	 *         contest
	 */
	...
	/**
	 * This mapped method used to set list of teachers that have rights to edit
	 * this contest.
	 * <p>
	 * <b>Note:</b>Only TEACHERs and ADMINs have rights to use this method.
	 *
	 ...
	 *            method
	 * @param userIds
	 *            List of users IDs that will have rights to edit contest
	 * @return Returns "SUCCESS" status if <b>success</b>. Returns "FAIL" status
	 *         if <b>fails</b>.
	 */
	@PreAuthorize("hasAnyRole('ROLE_ADMIN','ROLE_TEACHER')")
	 ...
	 *            This is general information about user, who tries to call this
	 *            method
	 * @return Returns status "TASK_SIZE", "FAIL_EMPTY", "FAIL_STARTS" or
	 *         "SUCCESS"
	 */
	@PreAuthorize("hasRole('ROLE_TEACHER')")
	...
	public @ResponseBody List<Contest> getContestListJson(
			@RequestParam("hidden") String stringHidden,
			@RequestParam("status") String stringStatus, Principal principal) {
		if (principal != null
				&& userService.getUserByUsername(principal.getName()).hasRole(
						"ROLE_TEACHER")) {
			return contestService.getContestsListByHiddenStatusUsername(
					stringHidden, stringStatus, principal.getName());
		} else {
