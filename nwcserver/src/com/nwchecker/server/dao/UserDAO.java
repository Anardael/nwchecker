...
/**
 * <h1>User DAO</h1>
 * DAO for working with User Entity table.
 * <p>
 *
...
public interface UserDAO {
     ...
     * <p>
     *
     * @param user User that will be inserted in DB
     */
     ...
     * <p>
     *
     * @param user User that will be updated in DB
     */
     ...
     * <p>
     *
     * @param user User that will be removed from DB
     */
     ...
     * @param userRequest Request that will be removed
     */
     ...
     * <p>
     *
     * @param id Unique ID of existing User
     * @return User from DB
     */
     ...
     * <p>
     *
     * @param role Specific Role of required users
     ...
     * @return <b>true</b> if Username exists
     *         <b>false</b> if Username do not exists
     */
     ...
     * @return <b>true</b> if Email exists
	...
	public List<User> getPagedUsersSortedAndFiltered(int startIndex, int pageSize, String sorting, String filter);
	public List<User> getPagedUsersSorted(int startIndex, int pageSize, String sorting);
	public List<User> getPagedUsersFiltered(int startIndex, int pageSize, String filter);
