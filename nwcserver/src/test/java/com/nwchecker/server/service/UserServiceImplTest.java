...
public class UserServiceImplTest {
    ...
    public void testAddUser() throws Exception {
        ...
        assertEquals(userService.getUserByUsername("userNew").getUsername(), "userNew");
    }
    ...
    public void testDeleteRequest() throws Exception {
        UserRequest userRequest = userService.getUserByUsername("user").getRequests().iterator().next();
        assertEquals(userService.getUsersWithRequests().size(), 1);
        userService.deleteRequest(userService.getUserByUsername("user"), userRequest);
    ...
    public void testGetUserByUsername() throws Exception {
        assertEquals(userService.getUserByUsername("admin").getUsername(), "admin");
        assertEquals(userService.getUserByUsername("teacher").getUsername(), "teacher");
        assertEquals(userService.getUserByUsername("user").getUsername(), "user");
    }
