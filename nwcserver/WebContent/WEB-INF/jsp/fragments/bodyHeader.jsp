...
<header>
    ...
    <div class="languageChoose">
        <a href="/NWCServer/index.do?locale=ua"><img src= "${resources}images/ukraineFlag.png" width="36" height="36"  alt="ua"></a>
        <a href="/NWCServer/index.do?locale=en"><img src="${resources}images/ukFlag.png" width="36" height="36"  alt="en"></a>
    </div>
    <!-- navigating toolbar -->
