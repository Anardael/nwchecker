            ...
            <div class="row">
                <aside class="col-md-3">
                    <ul class="list-group submenu">
                        ...
                        <li class="list-group-item"><a href="/donec/">Rules</a></li>
                        <li class="list-group-item"><a href="/vestibulum/">Contacts</a></li>
                        <li class="list-group-item"><a href="/etiam/">Archive</a></li>
                        <li class="list-group-item"><a href="/phasellus/">Forum</a></li>
                    </ul>
                </aside>
