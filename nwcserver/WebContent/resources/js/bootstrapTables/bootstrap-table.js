...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        search: false,
        searchAlign: 'right',
		clearSearch: false, //CHANGED - new parameter
        ...
        icons: {
			...
			clearSearch: 'glyphicon-remove icon-remove', //CHANGED - new element
    ...
    BootstrapTable.LOCALES['en-US'] = {
		...
		formatClearSearch: function () { //CHANGED - new function
			return 'Clear search';
		},
    ...
    BootstrapTable.prototype.initToolbar = function () {
		...
		*/
        ...
        if (this.options.search) { //CHANGED - new code included
            html = [];
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search"><div class="form-inline">',
                    sprintf('<input class="form-control' + (this.options.iconSize == undefined ? '' :  ' input-' + this.options.iconSize)  + '" name="search" type="text" placeholder="%s">',
                        this.options.formatSearch()));
			
			//CHANGED - new function
			// showClearSearch
			if (this.options.clearSearch) {
				html.push(sprintf('<button class="form-control btn btn-default' + (this.options.iconSize == undefined ? '' :  ' btn-' + this.options.iconSize) + '" type="button" name="clearSearch" title="%s">',
					this.options.formatClearSearch()),
					sprintf('<span class="%s %s"></span>', this.options.iconsPrefix, this.options.icons.clearSearch),
					'</button>');
			}
			...
			if (this.options.clearSearch) { //CHANGED - new button event
            this.$toolbar.find('button[name="clearSearch"]')
                .off('click').on('click', function () {
					$search.val("");
					$search.keyup();
				});
