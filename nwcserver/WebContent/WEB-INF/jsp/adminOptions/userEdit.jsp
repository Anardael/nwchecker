	...
	<form:form id="userEditForm" accept-charset="UTF-8"
		...
		<div class="form-group">
			<label class="col-sm-4 control-label"> <spring:message
					code="adminPanel.userEdit.username.caption" />
			</label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label"> <spring:message
					code="adminPanel.userEdit.displayName.caption" />
			</label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label"> <spring:message
					code="adminPanel.userEdit.email.caption" />
			</label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label"> <spring:message
					code="adminPanel.userEdit.password.caption" />
			</label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label"> <spring:message
					code="adminPanel.userEdit.confirmPass.caption" />
			</label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label"> <spring:message
					code="adminPanel.userEdit.roles.caption" />
			</label>
			<div class="col-sm-4">
				<input type="checkbox" id="admin" onclick="resetRolesDesc()" /> <label
					for="admin"> <spring:message
						code="adminPanel.userEdit.role.admin.caption" />
				</label> <br /> <input type="checkbox" id="teacher"
					onclick="resetRolesDesc()" /> <label for="teacher"> <spring:message
						code="adminPanel.userEdit.role.teacher.caption" />
				</label> <br /> <input type="checkbox" id="user" onclick="resetRolesDesc()" />
				<label for="user"> <spring:message
						code="adminPanel.userEdit.role.user.caption" />
				</label> <br /> <input type="text" id="rolesDesc" name="rolesDesc"
					hidden="true" />
		...
		<div class="form-group">
			<label class="col-sm-4 control-label"> <spring:message
					code="adminPanel.userEdit.department.caption" />
			</label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label"> <spring:message
					code="adminPanel.userEdit.info.caption" />
			</label>
			<div class="col-sm-4">
