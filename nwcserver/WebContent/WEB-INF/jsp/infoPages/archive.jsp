...
<body>
	...
	<table id="archiveTable" class="table" data-toggle="table"
		...
		data-clear-search="true" data-sort-name="id" data-search-align="left"
		data-sort-order="asc">
		<thead>
			<tr>
				...
				<th data-field="title" data-align="center" data-sortable="true">
                    <spring:message code="archive.taskTitle" /></th>
				<th data-field="complexity" data-align="center" data-sortable="true" class="col-md-2">
                    <spring:message code="archive.taskComplexity" /></th>
				<th data-field="rate" data-align="center" data-sortable="true"class="col-md-2">
					<spring:message code="archive.taskRate" /></th>
				<th data-field="timeLimit" data-align="center" data-sortable="true"class="col-md-2">
                    <spring:message code="archive.timeLimit" /></th>
			</tr>
		</thead>
	</table>
</body>
